...
#define NUMBER_QCMOSSH 4278194177 //Q_N761 ^{-1} mod 2^32
#define NUMBER_CINFGSK 33026177 //-2^32 mod Q_N761
#define FACTOR_CONFIHLNHM 20791006 //zetas[2] * R^{-1} mod Q_N761
#define FACTOR_JAOHADAH 33353745 //512^{-1} * R * R mod Q_N761
